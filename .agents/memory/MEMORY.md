...
- [Partial migration recovery](partial-migration-recovery.md) — never rewrite a failed or applied migration; complete it with a later idempotent recovery and keep failures visible.
