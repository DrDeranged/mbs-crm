...
<body>
  ...
  <div class="disclaimer">This is not a commitment to lend. All financing is subject to underwriting approval. My Business Solutions is a commercial finance brokerage.</div>
    ...
    variableFields: [
      ...
      { key: "rep_phone", label: "Rep Phone", type: "text", defaultValue: "(908) 860-8507" },
      { key: "rep_email", label: "Rep Email", type: "text", defaultValue: "funding@my-business-solutions.com" },
    ],
    isActive: true,
  },
  {
