...
export async function gatherBackupPayload(): Promise<BackupPayload> {
  const [
    ...
    db.select({
      ...
      annualRevenue: applicationsTable.annualRevenue,
      businessStartDate: applicationsTable.businessStartDate,
      yearsUnderCurrentOwnership: applicationsTable.yearsUnderCurrentOwnership,
      businessDescription: applicationsTable.businessDescription,
      estCreditScore: applicationsTable.estCreditScore,
      timelineFundsNeeded: applicationsTable.timelineFundsNeeded,
      ...
      equipmentCategory: applicationsTable.equipmentCategory,
      yearMakeModel: applicationsTable.yearMakeModel,
      trucksInFleet: applicationsTable.trucksInFleet,
      isHomeowner: applicationsTable.isHomeowner,
      downPaymentAmount: applicationsTable.downPaymentAmount,
      ...
      secondaryOwnerName: applicationsTable.secondaryOwnerName,
      secondaryOwnerEmail: applicationsTable.secondaryOwnerEmail,
      secondaryOwnerAddress: applicationsTable.secondaryOwnerAddress,
      secondaryOwnerSsnEncrypted: applicationsTable.secondaryOwnerSsnEncrypted,
      secondaryOwnerDob: applicationsTable.secondaryOwnerDob,
      secondaryOwnerOwnershipPct: applicationsTable.secondaryOwnerOwnershipPct,
      secondaryOwnerCell: applicationsTable.secondaryOwnerCell,
      secondaryOwnerEstCreditScore: applicationsTable.secondaryOwnerEstCreditScore,
      consentCreditPull: applicationsTable.consentCreditPull,
      consentTerms: applicationsTable.consentTerms,
      signatureMethod: applicationsTable.signatureMethod,
      signatureIp: applicationsTable.signatureIp,
      signatureSignedAt: applicationsTable.signatureSignedAt,
